...
class Author(CatalogMixin, Base):
    ...
    # The Profile who *is* this author, if any. Written ONLY by an approved
    # AuthorClaim (app/models/author_claim.py) — "This is me" files a claim for
    # manual review rather than linking on the spot, so this column never
    # reflects an unverified assertion. Drives the 🔗 "on Kitabi" badge and the
    # "Works" tab on that reader's public profile.
