                  ...
                  Wrap(
                    children: [
                      for (final (i, author) in authors.indexed) ...[
                        if (i > 0) const Text(', ', style: TextStyle(color: AppColors.inkSoft)),
                        GestureDetector(
                          onTap: () => context
                        ...
                        if (publisher != null)
                          GestureDetector(
                            ...
                            child: Text(
                              ...
                              style: const TextStyle(color: AppColors.oxblood, fontSize: 11),
                            ),
                          ),
                        if (publisher != null && year != null)
                          const Text(' · ', style: TextStyle(color: AppColors.inkSoft, fontSize: 11)),
                        if (year != null)
                          Text(
                            '$year',
