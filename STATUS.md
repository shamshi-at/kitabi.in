...
**Shipping state:** the mobile app now has release builds — an iOS **IPA (build 113)**
and an Android **AAB (build 113)**, built 9 Aug 2026 with the catalogue doors bar (and the
chained front→back cover capture from 112), **not yet uploaded** — the stores still run
